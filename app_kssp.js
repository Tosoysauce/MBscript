...
!(async() => {
 if(!cookieArr[0]){
      $.msg($.name, '【提示】🉐登录快手pp获取cookie',"", {"open-url": "https://live.kuaishou.com/fission/offkwai/index?cc=share_copylink&kpf=IPHONE&traceId=27&fid=884699286&code=3429390431&shareMethod=token&kpn=KUAISHOU&subBiz=INVITE_CODE&shareId=1000517297081&shareToken=X-1oTjAy1OkMhgQk_AO&platform=copylink&shareMode=app&shareObjectId=3429390431"});
      return
  }
...
function nebulaInfo() {
  ...
  return {
	...
	if (result.result == 1) {
          ...
          $.log("************ 昵称: "+nickname+" **********\n\n开始极速版任务\n");
          speed_rewards = result+'积分: '+result.data.totalCoin+'积分  现金: '+nebulacash+'元';
...
function bdinvet(){
   const bdurl = {
      url: 'http://apissl.gifshow.com/rest/nebula/inviteCode/bind?c=NEB_INVITE%2C3&apptype=22&did=ANDROID_6e55c7aaafd2ee49&kpn=NEBULA&keyconfig_state=2&deviceBit=0&sw=1080&kpf=ANDROID_PHONE&sourceType=9&sys=ANDROID_10&sh=340&kcv=1323&browseType=3&net=WIFI&darkMode=false&inviteCode=884699286&ver=9.5&sync=1&isp=CTCC&mod=blackshark%28SKW-A0%29&ud=1587224625&cold_launch_time_ms=1624892759129&vague=0&egid=DFPE9830A4AB6E78E965633E9FA38E560105922ACE0C6416F5286BF5BA50ED60&appver=9.5.30.1529',
